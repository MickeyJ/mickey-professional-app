...
import { sortCountryData, formatCountryData } from '@/lib/utils';
import LineChart from '@/_components/charts/line-chart';
import { min } from 'd3';

const defaultMinPopulation = 100000000;

const filterByPopulation = (minPopulation: number) => (d: Country) =>
  d.population > minPopulation;
  ...
  useEffect(() => {
    if (countryData.length) {
      setFilteredCountryData(
        countryData.filter(filterByPopulation(minPopulation))
      );
    }
